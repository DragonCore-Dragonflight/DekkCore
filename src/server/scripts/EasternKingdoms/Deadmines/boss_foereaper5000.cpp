                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_OVERDRIVE:
                            ...
                            Talk(SAY_SPELL3);
                            events.RescheduleEvent(EVENT_OVERDRIVE, 25s);
                            break;
                        case EVENT_REAPER_STRIKE:
                            DoCast(me->GetVictim(), SPELL_REAPER_STRIKE);
                            events.RescheduleEvent(EVENT_REAPER_STRIKE, 8s);
                            break;
                        case EVENT_HARVEST:
                            ...
                            events.RescheduleEvent(EVENT_HARVEST, 35s);
                            break;
                        }
                }
                    ...
                    switch (id)
                    {
                        case 1001:
                            ...
                            if(auto harvestTarget = ObjectAccessor::GetCreature(*me, harvestTargetGuid))
                                harvestTarget->DespawnOrUnsummon(1s);
                            break;
                    }
                }
            }
