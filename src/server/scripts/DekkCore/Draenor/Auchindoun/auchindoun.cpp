...
struct auchindoun_mob_sargerei_ritualist : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        me->CastStop();
        me->RemoveAllAuras();
        events.ScheduleEvent(eSargereiRitualistEvents::EventMindSpike, 7s);
    }
...
struct auchindoun_mob_sargerei_zealot : public ScriptedAI
{
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eAuchindounEvents::EventSeverTendom:
            ...
            events.ScheduleEvent(eAuchindounEvents::EventSeverTendom, 12s);
            break;
        default:
            break;
        }
...
struct auchindoun_mob_sargerei_hopilite : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        events.ScheduleEvent(eSargereiHopiliteEvents::EventShieldBash, 9s);
...
struct auchindoun_mob_sargerei_defender : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        events.ScheduleEvent(eSargereiDefenderEvents::EventAvengersShield, 14s);
        events.ScheduleEvent(eSargereiDefenderEvents::EventCrusaderStirke, 7s);
    }
...
struct auchindoun_mob_soul_priest : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        ...
        events.ScheduleEvent(eSoulPriestEvents::EventShadowWordPainSoulPriest, 9s);
    }
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eSoulPriestEvents::EventShadowWordPainSoulPriest:
            if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 100.0f, true, false, -eAuchindounSpells::SpellShadowWordPainPriest))
...
struct auchindoun_mob_sargeri_warden : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        ...
        events.ScheduleEvent(eWardenEvents::EventWardenHammer, 14s);
    }
...
struct auchindoun_mob_felborne_abyssal : public ScriptedAI
{
    ...
    void EnterCombat(Unit* p_Attacker)
    {
        events.ScheduleEvent(eFelborneAbyssalEvents::EventFixate, 18s);
    }
...
struct auchindoun_mob_felguard : public ScriptedAI
{
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eFelguardEvents::EventFelStomp:
            ...
            events.ScheduleEvent(eFelguardEvents::EventFelStomp, 14s);
            break;
        default:
            break;
        }
